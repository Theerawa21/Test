...
สร้าง `SESSION_SECRET` ใหม่ได้จาก Apps Script editor โดยรันชั่วคราวและคัดลอกค่าจาก Execution log:
...
หลังคัดลอกไปใส่ Script Properties แล้ว ให้ลบฟังก์ชันชั่วคราวนี้ออก ไม่ควร commit หรือส่ง secret ให้ผู้อื่น
...
3. ตั้ง Script Properties ที่ระบุด้านบนให้ครบ
...
7. ใช้ Web App URL `/exec` เดิมได้ จึงไม่ต้องเปลี่ยน URL ในหน้าเว็บ
